...
* **AWS EKS Cluster Active Status**:
  ![Figure 3.1: AWS Console active EKS Cluster Status](cluster-active.png)
* **AWS EKS Cluster Overview Details**:
  ![Figure 3.2: EKS details with Endpoint and OpenID Connect URLs](eks-clusterInfo.png.png)
...
* **GitHub Actions Green CI Logs**:
  ![Figure 4.1: Succeeded GitHub Actions CI Pipeline job logs](ci-cd pipeline.png)
...
* **Grafana Dashboard**:
  ![Figure 6.1: Live Grafana EKS Pod Metrics Monitor](k8s dashboard.png.png)
* **Loki Logs Stream**:
  ![Figure 6.2: Centralized Logging Stream logs in Grafana Explore](loki.png.png)
